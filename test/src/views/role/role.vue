...
<template>
  <el-container>
    ...
    <el-header>
      <el-form :model="roleRuleForm" ref="roleRuleForm">
        <el-form-item label="日期" prop="contractNo">
          <el-input v-model="roleRuleForm.date" placeholder="请输入内容"></el-input>
        </el-form-item>
        <el-form-item label="昵称" prop="nickName">
          <el-input v-model="roleRuleForm.nickName" placeholder="请输入内容"></el-input>
        </el-form-item>
        <el-form-item label="用户id" prop="userId">
          <el-input v-model="roleRuleForm.userId" placeholder="请输入内容"></el-input>
        </el-form-item>
        <el-form-item label="姓名" prop="contractNo" v-if="isshow">
          <el-input v-model="roleRuleForm.name" placeholder="请输入内容"></el-input>
        </el-form-item>
        <el-form-item label="姓名" prop="contractNo" v-if="isshow">
          <el-input v-model="roleRuleForm.name" placeholder="请输入内容"></el-input>
        </el-form-item>
      ...
      <el-table :data="tableList" border style="width: 100%" @sort-change="handSortChange">
        ...
        <el-table-column label="操作" width="130px">
          <template slot-scope="scope">
            ...
            <span class="lookMore" @click="showPermission(scope.row)">分配权限</span>
          </template>
        </el-table-column>
      </el-table>
      <el-pagination
